...
define config.name = _("herramientas_digitales_tp2_dumas")
...
define build.name = "herramientas_digitales_tp2_dumas"
...
define config.save_directory = "herramientas_digitales_tp2_dumas-1757515931"
